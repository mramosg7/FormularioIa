...
const [errorMesagge, dispatch] = useFormState(generateForm, undefined);
    ...
    return (
      <div onClick={()=>{setView(false)}} className='absolute w-[100vw] h-[100vh] bg-[rgb(0,0,0,.8)] text-secondary-300  flex items-center justify-center top-0 left-0'>
 ...
 function SubmitButton() {
    ...
    return (
      <button className={` ${pending ? "bg-primary-100/80" : "bg-primary-100"} rounded mt-2 text-white p-1`} aria-disabled={pending}>
